...
public class DynamicSecurityFilter extends AbstractSecurityInterceptor implements Filter {
  ...
  @Autowired
  public void setDanceAccessDecisionManager(DynamicAccessDecisionManager danceAccessDecisionManager) {
    super.setAccessDecisionManager(danceAccessDecisionManager);
  }
